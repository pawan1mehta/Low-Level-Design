...
- How delivery driver will deposit a package into available compartant?
- Will there be infinite number of compartants?

## Requirements

- Carrier should be able to deposit a package by specifying the small, medium or large size
  - upon successfull deposit an access token should be generated send to user
